...
SESSION_FILE = PROJECT_ROOT / ".l03_04_session.json"
CHECKPOINT_DB = PROJECT_ROOT / ".l03_04_checkpoints.sqlite"
EVENT_LOG = PROJECT_ROOT / ".l03_04_events.jsonl"
