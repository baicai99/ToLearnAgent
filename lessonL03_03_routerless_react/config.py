# -*- coding: utf-8 -*-
"""
标题：L03-03 配置与 .env 加载
执行：python -m lessonL03_03_routerless_react.main

[L03-03 NEW]
- 统一约定：工作区根目录就是 toy_repo；所有路径都相对 toy_repo（不要写 toy_repo/xxx）
"""
...
SESSION_FILE = PROJECT_ROOT / ".l03_03_session.json"
CHECKPOINT_DB = PROJECT_ROOT / ".l03_03_checkpoints.sqlite"
EVENT_LOG = PROJECT_ROOT / ".l03_03_events.jsonl"
