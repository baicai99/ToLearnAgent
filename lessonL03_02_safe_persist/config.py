...
标题：L03-02 配置与 .env 加载（模块化运行）

[L03-02 NEW]
- 强制“模块运行”来规避 sys.path 导入问题（不再发生 ModuleNotFoundError）
"""
...
SESSION_FILE = PROJECT_ROOT / ".l03_02_session.json"
CHECKPOINT_DB = PROJECT_ROOT / ".l03_02_checkpoints.sqlite"
EVENT_LOG = PROJECT_ROOT / ".l03_02_events.jsonl"
